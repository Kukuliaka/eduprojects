(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            const handlesSlider = document.querySelector("#range");
            if (handlesSlider) {
                handlesSlider.getAttribute("data-from");
                handlesSlider.getAttribute("data-to");
                initialize(handlesSlider, {
                    start: [ 50, 200 ],
                    connect: true,
                    range: {
                        min: [ 0 ],
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) new Swiper(".customers__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        const menuList = document.querySelector(".menu__sublist");
        const menuLinks = document.querySelectorAll(".menu__sublink");
        ...
        buttonSearch.addEventListener("click", (function() {
            document.documentElement.classList.toggle("input-open");
        }));
        const openBtn = document.querySelector(".body-category__button-icon");
        const closeBtn = document.getElementById("closebtn");
        const filter = document.querySelector(".filter");
        const wrapper = document.querySelector(".wrapper");
        if (openBtn !== null) openBtn.addEventListener("click", (e => {
            filter.classList.add("filter_show");
            wrapper.classList.add("filter-show");
        }));
        if (closeBtn !== null) closeBtn.addEventListener("click", (e => {
